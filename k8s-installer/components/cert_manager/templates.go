...
spec:
  ...
  validation:
    openAPIV3Schema:
      description:
        CertificateRequest is a type to represent a Certificate Signing
        Request
      type: object
      properties:
        apiVersion:
        ...
        spec:
          ...
          properties:
            ...
            isCA:
              description:
                IsCA will mark the resulting certificate as valid for signing.
        ...
        status:
          description:
            CertificateStatus defines the observed state of CertificateRequest
            and resulting signed certificate.
          type: object
          properties:
            ca:
              description:
                Byte slice containing the PEM encoded certificate authority
                of the signed certificate.
              type: string
              format: byte
            certificate:
              description:
                Byte slice containing a PEM encoded signed certificate
  ...
  validation:
    openAPIV3Schema:
      ...
      properties:
        ...
        spec:
          description:
            CertificateSpec defines the desired state of Certificate. A
          ...
          properties:
            ...
            dnsNames:
              description:
                DNSNames is a list of subject alt names to be used on the
                Certificate.
              type: array
              items:
                type: string
            ...
            isCA:
              description:
                IsCA will mark this Certificate as valid for signing. This
            ...
            uriSANs:
              description:
                URISANs is a list of URI Subject Alternative Names to be
        ...
        status:
          ...
          properties:
            conditions:
              ...
              items:
                description:
                  CertificateCondition contains condition information for
                  an Certificate.
                type: object
                required:
                  - status
            ...
            notAfter:
              description:
                The expiration time of the certificate stored in the secret
...
spec:
  ...
  validation:
    openAPIV3Schema:
      description:
        Challenge is a type to represent a Challenge request with an ACME
        server
      type: object
      required:
        - metadata
      properties:
        ...
        spec:
          ...
          properties:
            authzURL:
              description:
                AuthzURL is the URL to the ACME Authorization resource
            ...
            solver:
              description:
                Solver contains the domain solving configuration that should
              ...
              properties:
                dns01:
                  ...
                  properties:
                    acmedns:
                      description:
                        ACMEIssuerDNS01ProviderAcmeDNS is a structure containing
                    ...
                    akamai:
                      description:
                        ACMEIssuerDNS01ProviderAkamai is a structure containing
                    ...
                    azuredns:
                      description:
                        ACMEIssuerDNS01ProviderAzureDNS is a structure
                    ...
                    clouddns:
                      description:
                        ACMEIssuerDNS01ProviderCloudDNS is a structure
                    ...
                    cloudflare:
                      description:
                        ACMEIssuerDNS01ProviderCloudflare is a structure
                    ...
                    cnameStrategy:
                      description:
                        CNAMEStrategy configures how the DNS01 provider
                    ...
                    digitalocean:
                      description:
                        ACMEIssuerDNS01ProviderDigitalOcean is a structure
                    ...
                    rfc2136:
                      description:
                        ACMEIssuerDNS01ProviderRFC2136 is a structure containing
                      ...
                      properties:
                        ...
                        tsigAlgorithm:
                          description:
                            "The TSIG Algorithm configured in the DNS supporting
                        ...
                        tsigSecretSecretRef:
                          description:
                            The name of the secret containing the TSIG
                    ...
                    route53:
                      description:
                        ACMEIssuerDNS01ProviderRoute53 is a structure containing
                      ...
                      properties:
                        ...
                        hostedZoneID:
                          description:
                            If set, the provider will manage only this
                            zone in Route53 and will not do an lookup using the route53:ListHostedZonesByName
                            api call.
                          type: string
                        region:
                          description:
                            Always set the region when using AccessKeyID
                            and SecretAccessKey
                          type: string
                        role:
                          description:
                            Role is a Role ARN which the Route53 provider
                    ...
                    webhook:
                      description:
                        ACMEIssuerDNS01ProviderWebhook specifies configuration
                      ...
                      properties:
                        config:
                          description:
                            Additional configuration that should be passed
                        ...
                        groupName:
                          description:
                            The API group name that should be used when
                        ...
                        solverName:
                          description:
                            The name of the solver to use, as defined in
                            the webhook provider implementation. This will typically
                            be the name of the provider, e.g. 'cloudflare'.
                          type: string
                http01:
                  description:
                    ACMEChallengeSolverHTTP01 contains configuration detailing
                  ...
                  properties:
                    ingress:
                      ...
                      properties:
                        ...
                        podTemplate:
                          description:
                            Optional pod template used to configure the
                            ACME challenge solver pods used for HTTP01 challenges
                          type: object
                          properties:
                            metadata:
                              description:
                                ObjectMeta overrides for the pod used to
                              ...
                              properties:
                                annotations:
                                  description:
                                    Annotations that should be added to
                                ...
                                labels:
                                  description:
                                    Labels that should be added to the
                            ...
                            spec:
                              description:
                                PodSpec defines overrides for the HTTP01
                              ...
                              properties:
                                affinity:
                                  description:
                                    If specified, the pod's scheduling
                                    constraints
                                  type: object
                                  properties:
                                    nodeAffinity:
                        ...
                        serviceType:
                          description:
                            Optional service type for Kubernetes solver
                            service
                          type: string
                selector:
                  description:
                    Selector selects a set of DNSNames on the Certificate
                    resource that should be solved using this challenge solver.
                  type: object
                  properties:
                    dnsNames:
                      description:
                        List of DNSNames that this solver will be used
                    ...
                    dnsZones:
                      description:
                        List of DNSZones that this solver will be used
                    ...
                    matchLabels:
                      description:
                        A label selector that is used to refine the set
            ...
            url:
              description:
                URL is the URL of the ACME Challenge resource for this
        ...
        status:
          ...
          properties:
            presented:
              description:
                Presented will be set to true if the challenge values for
            ...
            processing:
              description:
                Processing is used to denote whether this challenge should
            ...
            reason:
              description:
                Reason contains human readable information on why the Challenge
                is in the current state.
              type: string
            state:
              description:
                State contains the current 'state' of the challenge. If
  ...
  validation:
    openAPIV3Schema:
      ...
      properties:
        ...
        spec:
          description:
            IssuerSpec is the specification of an Issuer. This includes
          ...
          properties:
            acme:
              ...
              properties:
                ...
                externalAccountBinding:
                  description:
                    ExternalAcccountBinding is a reference to a CA external
                  ...
                  properties:
                    keyAlgorithm:
                      description:
                        keyAlgorithm is the MAC key algorithm that the
                ...
                privateKeySecretRef:
                  description:
                    PrivateKey is the name of a secret containing the private
                ...
                solvers:
                  description:
                    Solvers is a list of challenge solvers that will be
                    ...
                    properties:
                      dns01:
                        ...
                        properties:
                          acmedns:
                            description:
                              ACMEIssuerDNS01ProviderAcmeDNS is a structure
                          ...
                          akamai:
                            description:
                              ACMEIssuerDNS01ProviderAkamai is a structure
                          ...
                          digitalocean:
                            description:
                              ACMEIssuerDNS01ProviderDigitalOcean is a
                          ...
                          rfc2136:
                            description:
                              ACMEIssuerDNS01ProviderRFC2136 is a structure
                            ...
                            properties:
                              nameserver:
                                description:
                                  "The IP address of the DNS supporting
                                  RFC2136. Required. Note: FQDN is not a valid value,
                                  only IP."
                                type: string
                              tsigAlgorithm:
                                description:
                                  "The TSIG Algorithm configured in the
                          ...
                          route53:
                            description:
                              ACMEIssuerDNS01ProviderRoute53 is a structure
                            ...
                            properties:
                              ...
                              hostedZoneID:
                                description:
                                  If set, the provider will manage only
                              ...
                              role:
                                description:
                                  Role is a Role ARN which the Route53
                          ...
                          webhook:
                            description:
                              ACMEIssuerDNS01ProviderWebhook specifies
                            ...
                            properties:
                              config:
                                description:
                                  Additional configuration that should
                              ...
                              groupName:
                                description:
                                  The API group name that should be used
                      ...
                      http01:
                        ...
                        properties:
                          ingress:
                            description:
                              The ingress based HTTP01 challenge solver
                            ...
                            properties:
                              class:
                                description:
                                  The ingress class to use when creating
                              ...
                              name:
                                description:
                                  The name of the ingress resource that
                              ...
                              podTemplate:
                                description:
                                  Optional pod template used to configure
                                  the ACME challenge solver pods used for HTTP01 challenges
                                type: object
                                properties:
                                  metadata:
                                    description:
                                      ObjectMeta overrides for the pod
                                    ...
                                    properties:
                                      annotations:
                                        description:
                                          Annotations that should be added
                                      ...
                                      labels:
                                        description:
                                          Labels that should be added to
                                  ...
                                  spec:
                                    description:
                                      PodSpec defines overrides for the
                                    ...
                                    properties:
                                      ...
                                      nodeSelector:
                                        description:
                                          "NodeSelector is a selector which
                              ...
                              serviceType:
                                description:
                                  Optional service type for Kubernetes
                                  solver service
                                type: string
                      selector:
                        description:
                        ...
                        properties:
                          dnsNames:
                            description:
                              List of DNSNames that this solver will be
                          ...
                          dnsZones:
                            description:
                              List of DNSZones that this solver will be
                          ...
                          matchLabels:
                            description:
                              A label selector that is used to refine the
            ...
            vault:
              ...
              properties:
                  ...
                  properties:
                    appRole:
                      ...
                      properties:
                        path:
                          description:
                            Where the authentication path is mounted in
                            Vault.
                          type: string
                        roleId:
                          type: string
                    ...
                    kubernetes:
                      description:
                        This contains a Role and Secret with a ServiceAccount
                      ...
                      properties:
                        mountPath:
                          description:
                            The Vault mountPath here is the mount path
                        ...
                        role:
                          description:
                            A required field containing the Vault Role
                ...
                caBundle:
                  description:
                    Base64 encoded CA bundle to validate Vault server certificate.
            ...
            venafi:
              description:
                VenafiIssuer describes issuer configuration details for
                Venafi Cloud.
              type: object
              required:
                - zone
              properties:
                cloud:
                  ...
                  properties:
                    apiTokenSecretRef:
                      description:
                        APITokenSecretRef is a secret key selector for
                ...
                tpp:
                  ...
                  properties:
                    caBundle:
                      description:
                        CABundle is a PEM encoded TLS certifiate to use
                    ...
                    credentialsRef:
                      description:
                        CredentialsRef is a reference to a Secret containing
        ...
        status:
          ...
          properties:
            ...
            conditions:
              ...
              items:
                description:
                  IssuerCondition contains condition information for an
                  Issuer.
                type: object
                required:
                  - status
      ...
      properties:
        ...
        spec:
          ...
          properties:
            ...
            csr:
              description:
                Certificate signing request bytes in DER encoding. This
            ...
            dnsNames:
              description:
                DNSNames is a list of DNS names that should be included
        ...
        status:
          ...
          properties:
            authorizations:
              description:
                Authorizations contains data returned from the ACME server
                on what authoriations must be completed in order to validate the DNS
                names specified on the Order.
              type: array
              items:
                description:
                  ACMEAuthorization contains data returned from the ACME
                ...
                properties:
                  challenges:
                    description:
                      Challenges specifies the challenge types offered
                    ...
                    items:
                      description:
                        Challenge specifies a challenge offered by the
                      ...
                      properties:
                        token:
                          description:
                            Token is the token that must be presented for
                        ...
                        url:
                          description:
                            URL is the URL of this challenge. It can be
                            used to retrieve additional metadata about the Challenge
                            from the ACME server.
                          type: string
                  identifier:
                    description:
                      Identifier is the DNS name to be validated as part
                      of this authorization
                    type: string
                  url:
                    description:
                      URL is the URL of the Authorization that must be
                      completed
                    type: string
                  wildcard:
                    description:
                      Wildcard will be true if this authorization is for
            ...
            certificate:
              description:
                Certificate is a copy of the PEM encoded certificate for
            ...
            failureTime:
              description:
                FailureTime stores the time that this order failed. This
                is used to influence garbage collection and back-off.
              type: string
              format: date-time
            finalizeURL:
              description:
                FinalizeURL of the Order. This is used to obtain certificates
                for this order once it has been completed.
              type: string
            reason:
              description:
                Reason optionally provides more information about a why
            ...
            url:
              description:
                URL of the Order. This will initially be empty when the
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: cert-manager
          image: {{with .ImageRegistry}}{{.}}/{{end}}caas4/cert-manager-cainjector:v0.13.1
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: cert-manager
          image: {{with .ImageRegistry}}{{.}}/{{end}}caas4/cert-manager-controller:v0.13.1
          imagePullPolicy: IfNotPresent
          args:
            - --v=2
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: cert-manager
          image: {{with .ImageRegistry}}{{.}}/{{end}}caas4/cert-manager-webhook:v0.13.1
          imagePullPolicy: IfNotPresent
          args:
            - --v=2
            - --secure-port=10250
